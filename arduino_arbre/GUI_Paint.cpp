...
void Paint_NewImage(UWORD Image_Name, UWORD Width, UWORD Height, UWORD Rotate, UWORD Color)
{
    ...
    Paint_Image.Width2 = (Paint_Image.Memory_Width % 8 == 0)? (Paint_Image.Memory_Width / 8 ): (Paint_Image.Memory_Width / 8 + 1);
...
void Paint_DrawPixel(UWORD Xpoint, UWORD Ypoint, UWORD Color)
{
    ...
    UDOUBLE Addr = Xpoint / 8 + Ypoint * Paint_Image.Width2 + Paint_Image.Image_Offset;
...
void Paint_DrawPixelBlack(UWORD Xpoint, UWORD Ypoint)
{
    // UWORD Height = Paint_Image.Memory_Height;
    //UWORD Width = (Paint_Image.Memory_Width % 8 == 0)? (Paint_Image.Memory_Width / 8 ): (Paint_Image.Memory_Width / 8 + 1);
    //UDOUBLE Offset = Paint_Image.Image_Offset;
...
void Paint_DrawPixelWhite(UWORD Xpoint, UWORD Ypoint)
{
    // UWORD Height = Paint_Image.Memory_Height;
    //UWORD Width = (Paint_Image.Memory_Width % 8 == 0)? (Paint_Image.Memory_Width / 8 ): (Paint_Image.Memory_Width / 8 + 1);
    //UDOUBLE Offset = Paint_Image.Image_Offset;
...
void Paint_DrawCircle(UWORD X_Center, UWORD Y_Center, UWORD Radius,
                      UWORD Color, DOT_PIXEL Dot_Pixel)
{
    ...
    while (XCurrent <= YCurrent ) { //Realistic circles
        ...
        for (sCountY = XCurrent; sCountY <= YCurrent; sCountY ++ ) {
              ...
              Paint_DrawPixelBlack(X_Center + XCurrent, Y_Center + sCountY);//1
              Paint_DrawPixelBlack(X_Center - XCurrent, Y_Center + sCountY);//2
              Paint_DrawPixelBlack(X_Center - sCountY, Y_Center + XCurrent);//3
              Paint_DrawPixelBlack(X_Center - sCountY, Y_Center - XCurrent);//4
              Paint_DrawPixelBlack(X_Center - XCurrent, Y_Center - sCountY);//5
              Paint_DrawPixelBlack(X_Center + XCurrent, Y_Center - sCountY);//6
              Paint_DrawPixelBlack(X_Center + sCountY, Y_Center - XCurrent);//7
              Paint_DrawPixelBlack(X_Center + sCountY, Y_Center + XCurrent);
